...
plotter.camera_position = [(26.78447185841887, -0.2345289564148499, 0.20499153074679874),
...
plotter.add_light(pv.Light(position=(-50, 0, 0), focal_point=center, color='white', intensity=1.2))

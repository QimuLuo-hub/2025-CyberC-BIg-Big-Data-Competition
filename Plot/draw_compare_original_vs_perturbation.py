...
def compare_xyz(file_orig, file_perturbed, out_root="new_image_compare",
                ...
                screenshot_size=(4000,3000), interactive=False):
    ...

    os.makedirs(out_root, exist_ok=True)

    coords_orig = read_xyz(file_orig)
    coords_pert = read_xyz(file_perturbed)
    ...
    plotter.camera_position = [
        ...
        (0.34706448907133985, 0.34488807803738486, 0.8721229581047207)
    ]
    ...
    orig_name = os.path.splitext(os.path.basename(file_orig))[0]
    pert_name = os.path.splitext(os.path.basename(file_perturbed))[0]
    out_file = f"compare_{orig_name}_{pert_name}.png"
...
if __name__ == "__main__":
    file_orig = "lowest_vs_perturbation/350_centered.xyz"
    file_perturbed = "lowest_vs_perturbation/example_m0.10.xyz"
    output_image = compare_xyz(file_orig, file_perturbed, out_root="lowest_vs_perturbation/results")
